	 ...
	 * @return XML string 
	 */
	const json2xml = function(json, options) {
		settings = {};
	 ...
	 * @return XML string
	 */
	const convertToXml = function(json, tagName, parentPath, depth) {
	 ...
	 */
	const createNodeFromArray = function(source, name, path, depth, suffix) {
		var xmlNode = '';
		if (source.length > 0) {
	 ...
	 */
	const createTextNode = function(name, text, parentDepth, suffix) {
