        ...
        <el-row class="content">
            ...
            <el-col :span="12" class="item">
                <el-row class="jsonHandle">
                    ...
                    <div class="toolItem" :class="{'active':showXml}" @click="showXml = !showXml" effect="dark" content="转XML" placement="top">
                        <i class="iconfont icon-file-excel-o"></i>
                        <transition name="el-fade-in">
                            <div class="tooltips">转XML</div>
                        </transition>
                    </div>
                ...
                <el-row class="jsonContent">
                    <vue-json-pretty v-show="!showMini && !showXml && !hasError && inputData" :data="json"></vue-json-pretty>  
                    <el-row v-show="showMini && !hasError && !showXml">{{miniData}}</el-row>
                    <el-row v-show="hasError" class="error">Error: Invalid data</el-row>
                    <xmp><el-row v-show="showXml && !hasError && !showMini" v-text="xmlData" /></xmp>
                </el-row>
            </el-col>
        </el-row>
    </el-row>
...
import { formatToJson ,jsonToXml } from '../../utils/Utils'
let fs = require('fs');
export default {
    name:'json-beautiful',
    components:{
